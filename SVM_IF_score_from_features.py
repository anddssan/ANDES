...
def oneclass_svm_minibatchtraining(input_file, num_sets, interval_size):
    ...
    sets = [X_scaler.iloc[i::num_sets] for i in range(num_sets)]
    ...
    for i, mini_batch in enumerate(sets):
        start_index = i
        mini_batch_subset = mini_batch.iloc[start_index::interval_size]  #### sampling in interval_size
...
def main():
    ...
    output_fda_svm = "SVM_score_from_fda.csv"
