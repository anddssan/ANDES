...
summary_statistics_to_fda <- function(input_ss_path){
...
main <- function() {
  input_ss_path <- 'summary_statistics.csv'
  output_fda_path <- 'fda_features.csv'
  
  features <- summary_statistics_to_fda(input_ss_path)
  write.csv(features, output_fda_path, row.names = FALSE)
}
